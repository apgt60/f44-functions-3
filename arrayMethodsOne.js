...
console.log("totalPoplulation:", totalPopulation)
...
// CODE HERE
const myStrongest  = monstersInYourPocket.filter(curr => curr.CP > 200)
...
/*
  Use a higher order method to get all the order totals after adding in the 
  sales tax (given to you as a tax rate, hint: you'll need to do some multiplication).
  Your answer should be an array of numbers, one total for each order.
*/

// CODE HERE
console.log("--Problem 5")
const ordersWithTax = orders.map(curr => curr.price + curr.price * curr.tax)
console.log("ordersWithTax:", ordersWithTax)
...
const bobsTotal = purchases.filter(curr => curr.owner === "Bob").reduce((acc, curr) => acc += curr.price, 0)
